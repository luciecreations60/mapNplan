...
function buildChecklist(t, type) {
  const shared = [
    ...
    checklist(t('templates.checklist.entryRequirements'), 'documents'),
    checklist(t('templates.checklist.documentCopies'), 'documents'),
    checklist(t('templates.checklist.insurance'), 'documents'),
    checklist(t('templates.checklist.healthCover'), 'documents'),
    checklist(t('templates.checklist.emergencyContacts'), 'documents'),
    checklist(t('templates.checklist.payment'), 'money'),
    checklist(t('templates.checklist.bankNotice'), 'money'),
    checklist(t('templates.checklist.localCurrency'), 'money'),
    checklist(t('templates.checklist.reservationCopies'), 'bookings'),
    checklist(t('templates.checklist.transportTickets'), 'bookings'),
    checklist(t('templates.checklist.chargers'), 'packing'),
    checklist(t('templates.checklist.powerAdapter'), 'technology'),
    checklist(t('templates.checklist.offlineMaps'), 'technology'),
    checklist(t('templates.checklist.phoneBackup'), 'technology'),
    checklist(t('templates.checklist.medication'), 'packing'),
    checklist(t('templates.checklist.weatherPacking'), 'packing'),
    checklist(t('templates.checklist.luggageLabels'), 'packing'),
  ];
  ...
  const specialised = {
    city: [
      ...
      checklist(t('templates.checklist.attractionBookings'), 'bookings'),
      checklist(t('templates.checklist.publicTransport'), 'bookings'),
      checklist(t('templates.checklist.dayBag'), 'packing'),
      checklist(t('templates.checklist.reusableBottle'), 'packing'),
    ],
    road: [
      checklist(t('templates.checklist.drivingLicence'), 'documents'),
      checklist(t('templates.checklist.internationalPermit'), 'documents'),
      checklist(t('templates.checklist.vehicleDocuments'), 'documents'),
      checklist(t('templates.checklist.rentalInspection'), 'bookings'),
      checklist(t('templates.checklist.roadTolls'), 'money'),
      checklist(t('templates.checklist.emergencyKit'), 'packing'),
      checklist(t('templates.checklist.spareKey'), 'packing'),
      checklist(t('templates.checklist.fuelPlan'), 'bookings'),
    ],
    beach: [
      ...
      checklist(t('templates.checklist.waterShoes'), 'packing'),
      checklist(t('templates.checklist.afterSun'), 'packing'),
      checklist(t('templates.checklist.beachTowel'), 'packing'),
      checklist(t('templates.checklist.waterActivityBooking'), 'bookings'),
      checklist(t('templates.checklist.reefSafe'), 'packing'),
    ],
    business: [
      checklist(t('templates.checklist.workDocuments'), 'documents'),
      checklist(t('templates.checklist.presentation'), 'technology'),
      checklist(t('templates.checklist.presentationBackup'), 'technology'),
      checklist(t('templates.checklist.businessOutfit'), 'packing'),
      checklist(t('templates.checklist.businessCards'), 'packing'),
      checklist(t('templates.checklist.meetingAddresses'), 'bookings'),
      checklist(t('templates.checklist.expensePolicy'), 'money'),
      checklist(t('templates.checklist.workConnectivity'), 'technology'),
    ],
  };
